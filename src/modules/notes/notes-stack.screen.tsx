...
import { NotesListScreen } from 'src/modules/notes/notes-list.screen';
import { NotesCreateNewScreen } from 'src/modules/notes/notes-create-new.screen';
import { NotesDetailsScreen } from 'src/modules/notes/notes-details.screen';
