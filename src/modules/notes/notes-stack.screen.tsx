...
import { NotesListScreen } from 'modules/notes/notes-list.screen';
import { NotesCreateNewScreen } from 'modules/notes/notes-create-new.screen';
import { NotesDetailsScreen } from 'modules/notes/notes-details.screen';
